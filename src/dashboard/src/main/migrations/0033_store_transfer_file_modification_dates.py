...
def data_migration(apps, schema_editor):
    ...
    MicroServiceChainLinkExitCode.objects.filter(microservicechainlink_id='307edcde-ad10-401c-92c4-652917c993ed').update(nextmicroservicechainlink_id=set_transfer_file_mod_dates_cl_pk)
